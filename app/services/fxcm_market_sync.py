...
class FXCMMarketSyncService:
    ...
    def _sync_poll_delay(self, interval: str) -> timedelta:
    ...
    def _is_allowed_today(
        ...
        elif weekday == 3:  # 周四（与周六对调：优先补 index）
            return category == "index"
        elif weekday == 4:  # 周五
            return category == "forex"
        elif weekday == 5:  # 周六（与周四对调：改采 crypto）
    ...
    def _calculate_next_sync_from(
        ...
        *,
        ...
        next_sync_from = now + self._sync_poll_delay(interval)
